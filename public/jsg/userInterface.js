...
function drawGameMenu(state1,desc1){
...
function drawGameBody(){
	...
	button0 = game.add.button(width*(1.5/6) ,buttonDispX,"buttonSheet",changeState,this,0,0,0);
	button0.name = "stats";
	button0.anchor.set(0.5);
	
	button1 = game.add.button(width*(2.5/6) ,buttonDispX,"buttonSheet",changeState,this,2,2,2);
	button1.name = "food";
	button1.anchor.set(0.5);
		
	button2 = game.add.button(width*(3.5/6) ,buttonDispX,"buttonSheet",changeState,this,7,7,7);
	button2.name = "shopFood";
	button2.anchor.set(0.5);	
	
	button3 = game.add.button(width*(4.5/6) ,buttonDispX,"buttonSheet",changeState,this,9,9,9);
	button3.name = "main";
